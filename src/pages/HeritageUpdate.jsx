...
export default (props) => {
  ...
  return (
    <>
      <PageTitle>Heritage Update</PageTitle>
   ...
   <button className="p-2 mt-2 space-y-2 w-40 mx-auto mt-10 border-2 border-black overflow-hidden text-sm font-medium text-black rounded-md shadow-inner dark:text-gray-300 dark:bg-gray-900">Update Heritage</button>
